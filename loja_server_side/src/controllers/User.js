...
module.exports = {
  ...
  async signup(req, res) {
    try {
      ...
      await connection
        .query(
          "INSERT INTO utilizador (nome, contacto, email, pass, isAdmin) VALUES (:nome, :contacto, :email, :password, false);",
          {
            replacements: {
              nome: nome,
              contacto: contacto,
  ...
  async getMoradas(req, res) {
    ...
    var moradas = [];
    await connection
      .query("SELECT * FROM moradautilizador where userid= :userid;", {
        replacements: {
          userid: userid,
        },
      })
