...
module.exports = {
    ...
    async getArtigoByQuery(req, res) {
        ...
        try {
            await connection
                .query(
                    "Select produto.preco,produto.desconto,produto.stock,produto.descricao,produto.nome,produto.produtoid,produto.imagens from produto,categoria, categoriaproduto where (UPPER(produto.nome) like :query) or" +
